...
| 任务名称  | 调用方式  | 一键预测 | 单条输入 | 多条输入 | 无限长度输入 | 定制化训练 | 
| :------------  | ---- | ---- | ---- | ---- | ---- | ---- |
| [中文分词](#中文分词) | `Taskflow("word_segmentation")` | ✅ | ✅ | ✅ | ✅ | ✅ | 
| [词性标注](#词性标注) | `Taskflow("pos_tagging")` | ✅ | ✅ | ✅ | ✅ | ✅ | 
| [命名实体识别](#命名实体识别)  | `Taskflow("ner")` | ✅ | ✅ | ✅ | ✅ | ✅ |
...
![image](https://user-images.githubusercontent.com/40840292/158438655-d6f3abfc-8c7d-4dc8-b3e0-9e9498c7afb0.gif)
